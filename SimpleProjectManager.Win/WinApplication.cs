...
public class SimpleProjectManagerWindowsFormsApplication : WinApplication {
    public SimpleProjectManagerWindowsFormsApplication() {
        ...
        DatabaseVersionMismatch += SimpleProjectManagerWindowsFormsApplication_DatabaseVersionMismatch;
        CustomizeLanguagesList += SimpleProjectManagerWindowsFormsApplication_CustomizeLanguagesList;
    }
